void __fastcall D3DXTex::CCodec_A1R5G5B5::Decode(D3DXTex::CCodec_A1R5G5B5 *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  float *v4; // r10
  ...
  for ( i = &v5[*((unsigned int *)this + 34)]; v5 < i; *(v4 - 1) = (float)(v7 >> 15) )
  {
    *v4 = (float)((*v5 >> 10) & 0x1F) * 0.032258064;
    v4 += 4;
    *(v4 - 3) = (float)((*v5 >> 5) & 0x1F) * 0.032258064;
    *(v4 - 2) = (float)(*v5 & 0x1F) * 0.032258064;
    v7 = *v5++;
  }
  if ( *((_DWORD *)this + 7) )
