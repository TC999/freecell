void __fastcall D3DXTex::CCodec_R32F::Decode(D3DXTex::CCodec_R32F *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  ...
  for ( i = &v5[*((unsigned int *)this + 34)]; v5 < i; v4 = (struct D3DXCOLOR *)((char *)v4 + 16) )
  {
    v7 = *v5++;
