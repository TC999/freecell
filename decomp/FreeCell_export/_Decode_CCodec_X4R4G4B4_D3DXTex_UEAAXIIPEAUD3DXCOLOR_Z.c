void __fastcall D3DXTex::CCodec_X4R4G4B4::Decode(D3DXTex::CCodec_X4R4G4B4 *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  float *v4; // r10
  ...
  for ( i = v5 + 2LL * *((unsigned int *)this + 34); v5 < i; *(v4 - 2) = (float)(v7 & 0xF) * 0.06666667 )
  {
