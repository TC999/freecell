char __fastcall MaterialAdditive::Initialize(MaterialAdditive *this)
{
  ...
  else
  {
    ...
    LODWORD(v13) = v4;
    LODWORD(v12) = 1;
    Log(2u, 354, "MaterialAlpha.cpp", L"Unable to create index buffer using MaxBatch: %d; hr %x(%s)", v12, v13, HResult);
    return 0;
  }
}
