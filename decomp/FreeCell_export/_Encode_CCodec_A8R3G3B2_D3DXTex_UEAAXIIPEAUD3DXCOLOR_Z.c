void __fastcall D3DXTex::CCodec_A8R3G3B2::Encode(D3DXTex::CCodec_A8R3G3B2 *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  ...
  if ( *((_DWORD *)this + 34) )
  {
    ...
    do
    {
      ...
      v25 = v11;
      v26 = v12;
      *(float *)&v22 = (float)(*(float *)&v8 + *(float *)((char *)v4 + v20 - 16)) * 7.0;
      *(float *)&v23 = (float)(*(float *)&v10 + *(float *)((char *)v4 + v20 - 12)) * 7.0;
      v24 = *(float *)(v14 + 4LL * (v16 & 3));
      *(float *)&v25 = (float)(*(float *)&v11 + *(float *)((char *)v4 + v20 - 8)) * 3.0;
      *(float *)&v26 = (float)(*(float *)&v12 + *(float *)((char *)v4 + v20 - 4)) * 255.0;
      ...
      if ( *((_QWORD *)this + 15) )
      {
        ...
        v11 = v25;
        v12 = v26;
        *(float *)(*((_QWORD *)this + 15) + v21) = (float)((float)((float)(*(float *)&v22 - (float)v27) / 7.0) * 0.1875)
                                                 + *(float *)(*((_QWORD *)this + 15) + v21);
        *(float *)(*((_QWORD *)this + 15) + v20) = (float)((float)((float)(*(float *)&v22 - (float)v27) / 7.0) * 0.3125)
                                                 + *(float *)(*((_QWORD *)this + 15) + v20);
        v32 = (float)(*(float *)&v22 - (float)v27) / 7.0;
        *(float *)&v8 = v32 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v31) = (float)(v32 * 0.0625)
                                                     + *(float *)(*((_QWORD *)this + 15) + 8 * v31);
        *(float *)(*((_QWORD *)this + 15) + v21 + 4) = (float)((float)((float)(*(float *)&v23 - (float)v28) / 7.0)
                                                             * 0.1875)
                                                     + *(float *)(*((_QWORD *)this + 15) + v21 + 4);
        *(float *)(*((_QWORD *)this + 15) + v20 + 4) = (float)((float)((float)(*(float *)&v23 - (float)v28) / 7.0)
                                                             * 0.3125)
                                                     + *(float *)(*((_QWORD *)this + 15) + v20 + 4);
        v33 = (float)(*(float *)&v23 - (float)v28) / 7.0;
        *(float *)&v10 = v33 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v31 + 4) = (float)(v33 * 0.0625)
                                                         + *(float *)(*((_QWORD *)this + 15) + 8 * v31 + 4);
        *(float *)(*((_QWORD *)this + 15) + v21 + 8) = (float)((float)((float)(*(float *)&v25 - (float)v29) / 3.0)
                                                             * 0.1875)
                                                     + *(float *)(*((_QWORD *)this + 15) + v21 + 8);
        *(float *)(*((_QWORD *)this + 15) + v20 + 8) = (float)((float)((float)(*(float *)&v25 - (float)v29) / 3.0)
                                                             * 0.3125)
                                                     + *(float *)(*((_QWORD *)this + 15) + v20 + 8);
        v34 = (float)(*(float *)&v25 - (float)v29) / 3.0;
        *(float *)&v11 = v34 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v31 + 8) = (float)(v34 * 0.0625)
                                                         + *(float *)(*((_QWORD *)this + 15) + 8 * v31 + 8);
        *(float *)&v12 = (float)(*(float *)&v26 - (float)v30) / 255.0;
        ...
        *(float *)(*((_QWORD *)this + 15) + 8 * v31 + 12) = (float)((float)((float)(*(float *)&v26 - (float)v30) / 255.0)
                                                                  * 0.0625)
