void __fastcall D3DXTex::CCodec_X8R8G8B8::Decode(D3DXTex::CCodec_X8R8G8B8 *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  float *v4; // r10
  ...
  for ( i = &v5[4 * *((unsigned int *)this + 34)]; v5 < i; *(v4 - 2) = (float)v7 * 0.0039215689 )
  {
