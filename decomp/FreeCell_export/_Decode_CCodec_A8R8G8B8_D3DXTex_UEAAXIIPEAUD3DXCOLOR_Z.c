void __fastcall D3DXTex::CCodec_A8R8G8B8::Decode(D3DXTex::CCodec_A8R8G8B8 *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  float *v4; // r10
  ...
  for ( i = &v5[4 * *((unsigned int *)this + 34)]; v5 < i; *(v4 - 1) = (float)*(v5 - 1) * 0.0039215689 )
  {
    *v4 = (float)v5[2] * 0.0039215689;
    v4 += 4;
    *(v4 - 3) = (float)v5[1] * 0.0039215689;
    v7 = *v5;
    v5 += 4;
    *(v4 - 2) = (float)v7 * 0.0039215689;
  }
  if ( *((_DWORD *)this + 7) )
