__int64 __fastcall D3DXTex::CBlt::BltBox2D_X4R4G4B4(D3DXTex::CBlt *this)
{
  __int64 v1; // rdx
  D3DXTex::CBlt *v2; // rsi
  char *v3; // rbx
  ...
  while ( v3 < v5 )
  {
    ...
    if ( (unsigned __int64)v3 < v7 )
    {
      do
      {
        ...
        v13 = *v9 & 0xF0F;
        v9 += 2;
        v14 = (*(_WORD *)v8 & 0xF0) + (v12 & 0xF0);
        v15 = (v10 & 0xF0F) + (*(_WORD *)v8 & 0xF0F) + v13;
        v8 += 4;
        *v6++ = ((v15 + (v11 & 0xF0Fu) + 514) >> 2) & 0xF0F | (((v10 & 0xF0) + v14 + (v11 & 0xF0u) + 32) >> 2) & 0xF0;
      }
