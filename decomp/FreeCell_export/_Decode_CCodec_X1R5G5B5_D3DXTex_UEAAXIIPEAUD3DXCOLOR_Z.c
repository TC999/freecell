void __fastcall D3DXTex::CCodec_X1R5G5B5::Decode(D3DXTex::CCodec_X1R5G5B5 *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  float *v4; // r10
  __int16 *v5; // rdx
  __int16 *i; // r8
  ...
  {
    *v4 = (float)(((unsigned __int16)*v5 >> 10) & 0x1F) * 0.032258064;
    v4 += 4;
    *(v4 - 3) = (float)(((unsigned __int16)*v5 >> 5) & 0x1F) * 0.032258064;
    v7 = *v5++;
    *(v4 - 1) = 1.0;
  }
  if ( *((_DWORD *)this + 7) )
