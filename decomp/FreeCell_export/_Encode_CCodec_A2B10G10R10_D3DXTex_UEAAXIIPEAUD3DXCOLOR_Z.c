void __fastcall D3DXTex::CCodec_A2B10G10R10::Encode(
        D3DXTex::CCodec_A2B10G10R10 *this,
        int a2,
        int a3,
        struct D3DXCOLOR *a4)
{
  ...
  if ( *((_DWORD *)this + 34) )
  {
    ...
    do
    {
      ...
      v23 = v12;
      v24 = v11;
      *(float *)&v20 = (float)(*(float *)&v10 + *(float *)((char *)v4 + v18 - 12)) * 1023.0;
      *(float *)&v21 = (float)(*(float *)&v8 + *(float *)((char *)v4 + v18 - 16)) * 1023.0;
      v22 = *(float *)(v14 + 4LL * (v16 & 3));
      *(float *)&v23 = (float)(*(float *)&v12 + *(float *)((char *)v4 + v18 - 4)) * 3.0;
      *(float *)&v24 = (float)(*(float *)&v11 + *(float *)((char *)v4 + v18 - 8)) * 1023.0;
      ...
      if ( *((_QWORD *)this + 15) )
      {
        ...
        v11 = v24;
        v12 = v23;
        *(float *)(*((_QWORD *)this + 15) + v19) = (float)((float)((float)(*(float *)&v21 - (float)v26) / 1023.0)
                                                         * 0.1875)
                                                 + *(float *)(*((_QWORD *)this + 15) + v19);
        *(float *)(*((_QWORD *)this + 15) + v18) = (float)((float)((float)(*(float *)&v21 - (float)v26) / 1023.0)
                                                         * 0.3125)
                                                 + *(float *)(*((_QWORD *)this + 15) + v18);
        v30 = (float)(*(float *)&v21 - (float)v26) / 1023.0;
        *(float *)&v8 = v30 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v29) = (float)(v30 * 0.0625)
                                                     + *(float *)(*((_QWORD *)this + 15) + 8 * v29);
        *(float *)(*((_QWORD *)this + 15) + v19 + 4) = (float)((float)((float)(*(float *)&v20 - (float)v25) / 1023.0)
                                                             * 0.1875)
                                                     + *(float *)(*((_QWORD *)this + 15) + v19 + 4);
        *(float *)(*((_QWORD *)this + 15) + v18 + 4) = (float)((float)((float)(*(float *)&v20 - (float)v25) / 1023.0)
                                                             * 0.3125)
                                                     + *(float *)(*((_QWORD *)this + 15) + v18 + 4);
        v31 = (float)(*(float *)&v20 - (float)v25) / 1023.0;
        *(float *)&v10 = v31 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v29 + 4) = (float)(v31 * 0.0625)
                                                         + *(float *)(*((_QWORD *)this + 15) + 8 * v29 + 4);
        *(float *)(*((_QWORD *)this + 15) + v19 + 8) = (float)((float)((float)(*(float *)&v24 - (float)v28) / 1023.0)
                                                             * 0.1875)
                                                     + *(float *)(*((_QWORD *)this + 15) + v19 + 8);
        *(float *)(*((_QWORD *)this + 15) + v18 + 8) = (float)((float)((float)(*(float *)&v24 - (float)v28) / 1023.0)
                                                             * 0.3125)
                                                     + *(float *)(*((_QWORD *)this + 15) + v18 + 8);
        v32 = (float)(*(float *)&v24 - (float)v28) / 1023.0;
        *(float *)&v11 = v32 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v29 + 8) = (float)(v32 * 0.0625)
                                                         + *(float *)(*((_QWORD *)this + 15) + 8 * v29 + 8);
        *(float *)&v12 = (float)(*(float *)&v23 - (float)v42) / 3.0;
        ...
        *(float *)(*((_QWORD *)this + 15) + 8 * v29 + 12) = (float)((float)((float)(*(float *)&v23 - (float)v42) / 3.0)
                                                                  * 0.0625)
