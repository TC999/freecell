void __fastcall particleSuitCreation(struct NodeEmitter *this)
{
  XmlNode *v2; // rdi
  ...
  if ( !byte_1000B1CDD )
  {
    ...
    if ( !v2 )
      return;
    dword_1000B1E14 = XmlNode::GetXmlFloat(*((XmlNode **)this + 65), L"/rate", 0.0);
    XmlFloat = XmlNode::GetXmlFloat(v2, L"/life", 0.0);
    byte_1000B1CDD = 1;
    dword_1000B1E10 = LODWORD(XmlFloat);
  }
  if ( *((float *)this + 132) == 0.0 )
  {
    v4 = 0;
    if ( *(float *)&dword_1000B1E14 > 0.0 )
    {
      do
      {
        ...
        if ( !v5 )
          break;
        v6 = (float)((10 - rand() % 20) / 100 + 1) * *(float *)&dword_1000B1E10;
