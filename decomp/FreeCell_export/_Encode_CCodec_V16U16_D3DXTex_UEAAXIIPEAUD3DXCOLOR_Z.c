void __fastcall D3DXTex::CCodec_V16U16::Encode(D3DXTex::CCodec_V16U16 *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  ...
  if ( *((_DWORD *)this + 34) )
  {
    ...
    do
    {
      ...
      v23 = v10;
      v21 = v14 & 3;
      *(float *)&v22 = (float)(*(float *)&v8 + *(float *)((char *)v4 + v19 - 16)) * 32767.0;
      *(float *)&v23 = (float)(*(float *)&v10 + *(float *)((char *)v4 + v19 - 12)) * 32767.0;
      ...
      if ( *((_QWORD *)this + 15) )
      {
        ...
        v26 = 2 * (v15 + v16 + 1);
        v10 = v23;
        *(float *)(v20 + *((_QWORD *)this + 15)) = (float)((float)((float)(*(float *)&v22 - (float)v24) / 32767.0)
                                                         * 0.1875)
                                                 + *(float *)(v20 + *((_QWORD *)this + 15));
        *(float *)(v19 + *((_QWORD *)this + 15)) = (float)((float)((float)(*(float *)&v22 - (float)v24) / 32767.0)
                                                         * 0.3125)
                                                 + *(float *)(v19 + *((_QWORD *)this + 15));
        v27 = (float)(*(float *)&v22 - (float)v24) / 32767.0;
        *(float *)&v8 = v27 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v26) = (float)(v27 * 0.0625)
                                                     + *(float *)(*((_QWORD *)this + 15) + 8 * v26);
        *(float *)&v10 = (float)(*(float *)&v23 - (float)v25) / 32767.0;
        ...
        *(float *)(*((_QWORD *)this + 15) + 8 * v26 + 4) = (float)((float)((float)(*(float *)&v23 - (float)v25) / 32767.0)
                                                                 * 0.0625)
