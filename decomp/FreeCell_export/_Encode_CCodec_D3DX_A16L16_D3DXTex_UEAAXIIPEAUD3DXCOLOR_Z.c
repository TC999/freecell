void __fastcall D3DXTex::CCodec_D3DX_A16L16::Encode(
        ...
        struct D3DXCOLOR *a4)
{
  ...
  v12 = (int *)(*((_QWORD *)this + 5)
              ...
              + 4 * (unsigned int)(v8 - 1) * (unsigned __int64)(a2 & 1));
  ...
  if ( *((_DWORD *)this + 34) )
  {
    ...
    do
    {
      ...
      v26 = v11;
      v24 = v17 & 3;
      *(float *)&v25 = (float)(*(float *)&v9 + *(float *)((char *)v4 + v22 - 16)) * 65535.0;
      *(float *)&v26 = (float)(*(float *)&v11 + *(float *)((char *)v4 + v22 - 4)) * 65535.0;
      ...
      if ( *((_QWORD *)this + 15) )
      {
        ...
        v29 = 2 * (v18 + v19 + 1);
        v11 = v26;
        *(float *)(*((_QWORD *)this + 15) + v23) = (float)((float)((float)(*(float *)&v25 - (float)v27) / 65535.0)
                                                         * 0.1875)
                                                 + *(float *)(*((_QWORD *)this + 15) + v23);
        *(float *)(*((_QWORD *)this + 15) + v22) = (float)((float)((float)(*(float *)&v25 - (float)v27) / 65535.0)
                                                         * 0.3125)
                                                 + *(float *)(*((_QWORD *)this + 15) + v22);
        v30 = (float)(*(float *)&v25 - (float)v27) / 65535.0;
        *(float *)&v9 = v30 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v29) = (float)(v30 * 0.0625)
                                                     + *(float *)(*((_QWORD *)this + 15) + 8 * v29);
        *(float *)&v11 = (float)(*(float *)&v26 - (float)v28) / 65535.0;
        ...
        *(float *)(*((_QWORD *)this + 15) + 8 * v29 + 12) = (float)((float)((float)(*(float *)&v26 - (float)v28)
                                                                          / 65535.0)
                                                                  * 0.0625)
