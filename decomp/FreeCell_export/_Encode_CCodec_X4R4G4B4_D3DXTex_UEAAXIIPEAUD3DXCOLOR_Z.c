void __fastcall D3DXTex::CCodec_X4R4G4B4::Encode(D3DXTex::CCodec_X4R4G4B4 *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  ...
  if ( *((_DWORD *)this + 34) )
  {
    ...
    do
    {
      ...
      v21 = v15 & 3;
      v24 = v11;
      *(float *)&v22 = (float)(*(float *)&v8 + *(float *)((char *)v4 + v18 - 16)) * 15.0;
      *(float *)&v23 = (float)(*(float *)&v10 + *(float *)((char *)v4 + v18 - 12)) * 15.0;
      *(float *)&v24 = (float)(*(float *)&v11 + *(float *)((char *)v4 + v18 - 8)) * 15.0;
      ...
      if ( *((_QWORD *)this + 15) )
      {
        ...
        v10 = v23;
        v11 = v24;
        *(float *)(*((_QWORD *)this + 15) + v20) = (float)((float)((float)(*(float *)&v22 - (float)v25) / 15.0) * 0.1875)
                                                 + *(float *)(*((_QWORD *)this + 15) + v20);
        *(float *)(v18 + *((_QWORD *)this + 15)) = (float)((float)((float)(*(float *)&v22 - (float)v25) / 15.0) * 0.3125)
                                                 + *(float *)(v18 + *((_QWORD *)this + 15));
        v29 = (float)(*(float *)&v22 - (float)v25) / 15.0;
        *(float *)&v8 = v29 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v28) = (float)(v29 * 0.0625)
                                                     + *(float *)(*((_QWORD *)this + 15) + 8 * v28);
        *(float *)(*((_QWORD *)this + 15) + v20 + 4) = (float)((float)((float)(*(float *)&v23 - (float)v26) / 15.0)
                                                             * 0.1875)
                                                     + *(float *)(*((_QWORD *)this + 15) + v20 + 4);
        *(float *)(v18 + *((_QWORD *)this + 15) + 4) = (float)((float)((float)(*(float *)&v23 - (float)v26) / 15.0)
                                                             * 0.3125)
                                                     + *(float *)(v18 + *((_QWORD *)this + 15) + 4);
        v30 = (float)(*(float *)&v23 - (float)v26) / 15.0;
        *(float *)&v10 = v30 * 0.4375;
        *(float *)(*((_QWORD *)this + 15) + 8 * v28 + 4) = (float)(v30 * 0.0625)
                                                         + *(float *)(*((_QWORD *)this + 15) + 8 * v28 + 4);
        *(float *)&v11 = (float)(*(float *)&v24 - (float)v27) / 15.0;
        ...
        *(float *)(*((_QWORD *)this + 15) + 8 * v28 + 8) = (float)((float)((float)(*(float *)&v24 - (float)v27) / 15.0)
                                                                 * 0.0625)
