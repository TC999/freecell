__int64 __fastcall D3DXCore::CSprite::SetWorldViewRH(
...
LABEL_10:
  ...
  *((_DWORD *)this + 50) = v7[2] ^ _mask__NegFloat_;
  *((_DWORD *)this + 51) = v7[6] ^ _mask__NegFloat_;
  *((_DWORD *)this + 52) = v7[10] ^ _mask__NegFloat_;
