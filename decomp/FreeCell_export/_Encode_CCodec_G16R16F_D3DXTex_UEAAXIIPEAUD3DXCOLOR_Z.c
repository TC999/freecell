void __fastcall D3DXTex::CCodec_G16R16F::Encode(D3DXTex::CCodec_G16R16F *this, int a2, int a3, struct D3DXCOLOR *a4)
{
  unsigned int v4; // ebx
  ...
  if ( *((_DWORD *)this + 34) )
  {
    do
    {
      off_1000AC650(v9, (const float *)v5 + 4 * v4++, 2u);
      v9 = (struct D3DXFLOAT16 *)((char *)v9 + 4);
    }
